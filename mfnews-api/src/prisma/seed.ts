...
const newsData = [
  {
    category: "Fútbol",
    title:
      "Lamine Yamal: 'Soñaba con jugar un clásico' confiesa la joven promesa",
    author: "MARIO JIMÉNEZ",
    date: "2025-05-28T18:00:00.000Z",
    imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuhtD4lcNT9g47LcFEAmYN_fFoWHtrCf1f9copZIUAjdEzaYSlueF6IabUEAKF6GWBG8g7RpOMHxOJbMjR4H3lkw",
    summary:
      "El joven talento azulgrana se muestra ilusionado ante su primer clásico como titular.",
  ...
  },
  {
    category: "NBA",
    title:
      "LeBron James alcanza nuevo récord de triples-dobles en la temporada",
    author: "JULIA MARTÍNEZ",
    date: "2025-05-15T20:30:00.000Z",
    imageUrl:
      "https://img.olympics.com/images/image/private/t_social_share_thumb/f_auto/v1672757509/primary/n8oqmhtvrf9lc6hkszlj",
    summary:
      "La estrella de Los Angeles Lakers continúa haciendo historia con una actuación espectacular.",
  ...
  },
  {
    ...
    imageUrl:
      "https://e00-elmundo.uecdn.es/assets/multimedia/imagenes/2025/06/02/17488537884154.jpg",
    summary:
      "El joven español reafirma su dominio en la tierra batida italiana.",
  ...
  },
  {
    ...
    summary:
      "El club blanco refuerza su plantilla con un jugador internacional de renombre.",
  ...
  },
  {
    category: "NBA",
    title:
      "Golden State Warriors se coronan campeones tras un intenso séptimo partido",
    author: "MARTA RUIZ",
    ...
    summary:
      "Stephen Curry lidera a los Warriors para conquistar otro título de la NBA.",
  ...
  },
  {
    ...
    imageUrl:
      "https://s3.amazonaws.com/rtvc-assets-senalcolombia.gov.co/s3fs-public/field/image/leyendas-deportes-serena-williams.jpg",
    summary:
      "La leyenda del tenis mundial anuncia su despedida en un emotivo comunicado.",
  ...
  },
  {
    ...
    imageUrl:
      "https://a3.espncdn.com/combiner/i?img=%2Fphoto%2F2022%2F1209%2Fr1104518_1296x729_16%2D9.jpg",
    summary:
      "Lionel Scaloni prueba nuevas figuras en los amistosos previos a la cita mundialista.",
  ...
  },
  {
    ...
    imageUrl:
      "https://wfnz.com/wp-content/uploads/sites/86/2025/05/17471532202872.jpg?w=1024&strip=all&quality=80",
    summary:
      "Análisis de los jóvenes talentos que podrían cambiar el rumbo de sus franquicias.",
  ...
  },
  {
    ...
    imageUrl:
      "https://www.atptour.com/-/media/2024-images/news/2025/06/04/22/07/djokovic-roland-garros-2025-qf-smile.jpg",
    summary:
      "Novak Djokovic supera récords y se acerca a ser el máximo ganador de todos los tiempos.",
  ...
  },
  {
    ...
    summary:
      "El club reafirma la confianza en su entrenador para mantener la hegemonía.",
